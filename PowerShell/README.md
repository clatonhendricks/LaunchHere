# LaunchHere — PowerShell flavor (Phase 1)

> Registry-based install. No admin, no DLLs, no MSIX, works on Win10 and Win11.
> For the Win11-main-menu MSIX flavor, see [`../MSIX/`](../MSIX/).
